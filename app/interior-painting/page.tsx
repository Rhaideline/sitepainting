...
import InteractiveRoomVisualizer from "@/components/InteractiveRoomVisualizer";
...
export default function InteriorPaintingPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <Header currentPage="interior-painting" />
      ...
      <InteractiveRoomVisualizer
        title="See Your Colors Come to Life"
        subtitle="Try different wall colors on this modern living room before committing"
        compact={true}
      />
